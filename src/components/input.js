	...
	return (
		<div>
			...
			<fieldset>
				...
				<div>
					<input type="checkbox" id="attend-1" name="attendance" value="attendingCeremony" onChange={props.handleChange} />
					<label htmlFor="attend-1">Ceremony + brunch reception</label>
					<div>11am at the <span>Queens Botanical Garden</span></div>
				</div>

				<div>
					<input type="checkbox" id="attend-2" name="attendance" value="attendingBanquet" onChange={props.handleChange} />
